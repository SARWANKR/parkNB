...
const userSchema=new mongoose.Schema({
    ...
    // interests : [{type:mongoose.Type.ObjectId,refer:'interests'}],
    // vehicles : [{type:mongoose.Type.ObjectId,refer:'vehicles'}],
    // amenities : [{type:mongoose.Type.ObjectId,refer:'amenities'}],
